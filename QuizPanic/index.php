   ...
   <div class="container-login">
      <form method="POST" action="login.php" style="zoom: 120%; -moz-transform: scale(1.2);">
         <div class="username">
            ...
            <input autocomplete="off" autocomplete="new-password" type="text" name="username" placeholder="<?php if(isset($_COOKIE["username"]) && $_COOKIE["username"] != "") echo $_COOKIE["username"]; else echo "Username" ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'" required>
         </div>
         <div class="password">
